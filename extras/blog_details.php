        ...
        while ($row = $established_connection -> fetch_assoc()) { // fetching row as an associative array using while loop.
            ...
            <div class='box-container'>";
                echo "<div class='box'>";
                    ...
                    echo "<h3>" .$row['blog_description']. "</h3>"; // displaying the result.
                    echo "<a href='#'> <i class='fas fa-calendar'></i> ".$row['updated_on']."</a>"; // displaying the result.
                    echo "<a href='#'> <i class='fas fa-user'></i> By ".$row['name']."</a>"; // displaying the result.
                    echo "</div>";
                echo "</div>";
            echo "</div>";
        }
