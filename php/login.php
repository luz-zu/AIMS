<?php
    ...
    $mysql_query = "SELECT * from farmer_details WHERE (username = '$username' or email = '$username') and password = '$password'"; // returns a set of records from the specified table.
